...
7. Address every critical and major issue; resolve or disclose medium issues, remove unsupported claims, and reduce confidence where verification remains incomplete.
8. Deliver the final answer using [references/final-answer-template.md](references/final-answer-template.md), adapted to scope.
