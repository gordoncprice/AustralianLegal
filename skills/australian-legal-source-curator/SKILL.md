...
8. Explain unavailable or unverified sources and propose a safe fallback. Use `not located in the sources checked` rather than `does not exist` unless an authoritative, sufficiently complete register or source establishes the negative claim.
